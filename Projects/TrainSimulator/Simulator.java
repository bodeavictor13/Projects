...
public class Simulator {
	...
	public static void main(String[] args) {
		...
		Train t3 = new Train("Cluj-Napoca","P-003");
		s7.arriveTrain(t3);
...
class Controler{
	...
	ArrayList<Controler> neighbourControllersList = new ArrayList<Controler>();
	...
	void addNeighbourController(Controler v) {
		neighbourControllersList.add(v);
	}
	...
	void controlStep(){
        ...
        for(Segment segment:list){
            if(segment.hasTrain()){
                ...
                for(Controler controler:neighbourControllersList)
                {
